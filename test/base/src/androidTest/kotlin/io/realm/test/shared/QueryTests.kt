...
//        realm.query(Sample::class)
//            .let { query ->
//                val nullableIntAvg = query.average(Sample::nullableIntField.name, Int::class)
//                    .find()
//                assertNull(nullableIntAvg)
//                val nullableLongAvg = query.average(Sample::nullableLongField.name, Long::class)
//                    .find()
//                assertNull(nullableLongAvg)
//                val nullableFloatAvg = query.average(Sample::nullableFloatField.name, Float::class)
//                    .find()
//                assertNull(nullableFloatAvg)
//            }
//    }
//
//    @Test
...
//        realm.query(Sample::class)
//            .let { query ->
//                val nullableIntAvg = query.average(Sample::nullableIntField.name).find()
//                assertNull(nullableIntAvg)
//                val nullableLongAvg = query.average(Sample::nullableLongField.name).find()
//                assertNull(nullableLongAvg)
//                val nullableFloatAvg = query.average(Sample::nullableFloatField.name).find()
//                assertNull(nullableFloatAvg)
//                val nullableDoubleAvg = query.average(Sample::nullableDoubleField.name).find()
//                assertNull(nullableDoubleAvg)
//            }
//    }
//
//    @Test
