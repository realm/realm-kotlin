...
internal open class CredentialImpl constructor(
    ...
    companion object {
        ...
        internal fun jwt(jwtToken: String): NativePointer =
            RealmInterop.realm_app_credentials_new_jwt(jwt)
    }
}
