...
expect object RealmInterop {
    ...
    fun realm_collection_changes_get_changes(change: NativePointer): CollectionChanges
    fun realm_collection_changes_get_ranges(change: NativePointer): CollectionRanges
