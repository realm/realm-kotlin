...
expect object RealmInterop {
    ...
    fun <T, R> realm_collection_changes_get_changes(change: NativePointer, builder: CollectionChangeBuilder<T, R>)
    fun <T, R> realm_collection_changes_get_ranges(change: NativePointer, builder: CollectionChangeBuilder<T, R>)
