...
import realm_wrapper.realm_app_error_category_e

actual enum class ErrorCategory(override val nativeValue: realm_app_error_category_e) :
    NativeEnum<realm_app_error_category_e> {
    ...
    actual companion object : CinteropEnumCompanion<ErrorCategory> {
        override fun from(value: Int): ErrorCategory = enumFromValue(value.toUInt())
    }
}
