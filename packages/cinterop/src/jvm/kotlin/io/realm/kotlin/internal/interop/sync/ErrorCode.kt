...
//    RLM_ERR_WEBSOCKET_GOINGAWAY("websocketGoingaway", realm_errno_e.RLM_ERR_WEBSOCKET_GOINGAWAY),
//    RLM_ERR_WEBSOCKET_PROTOCOLERROR("websocketProtocolerror", realm_errno_e.RLM_ERR_WEBSOCKET_PROTOCOLERROR),
//    RLM_ERR_WEBSOCKET_UNSUPPORTEDDATA("websocketUnsupporteddata", realm_errno_e.RLM_ERR_WEBSOCKET_UNSUPPORTEDDATA),
//    RLM_ERR_WEBSOCKET_RESERVED("websocketReserved", realm_errno_e.RLM_ERR_WEBSOCKET_RESERVED),
//    RLM_ERR_WEBSOCKET_NOSTATUSRECEIVED("websocketNostatusreceived", realm_errno_e.RLM_ERR_WEBSOCKET_NOSTATUSRECEIVED),
//    RLM_ERR_WEBSOCKET_ABNORMALCLOSURE("websocketAbnormalclosure", realm_errno_e.RLM_ERR_WEBSOCKET_ABNORMALCLOSURE),
//    RLM_ERR_WEBSOCKET_INVALIDPAYLOADDATA("websocketInvalidpayloaddata", realm_errno_e.RLM_ERR_WEBSOCKET_INVALIDPAYLOADDATA),
//    RLM_ERR_WEBSOCKET_POLICYVIOLATION("websocketPolicyviolation", realm_errno_e.RLM_ERR_WEBSOCKET_POLICYVIOLATION),
//    RLM_ERR_WEBSOCKET_MESSAGETOOBIG("websocketMessagetoobig", realm_errno_e.RLM_ERR_WEBSOCKET_MESSAGETOOBIG),
//    RLM_ERR_WEBSOCKET_INAVALIDEXTENSION("websocketInavalidextension", realm_errno_e.RLM_ERR_WEBSOCKET_INAVALIDEXTENSION),
//    RLM_ERR_WEBSOCKET_INTERNALSERVERERROR("websocketInternalservererror", realm_errno_e.RLM_ERR_WEBSOCKET_INTERNALSERVERERROR),
//    RLM_ERR_WEBSOCKET_TLSHANDSHAKEFAILED("websocketTlshandshakefailed", realm_errno_e.RLM_ERR_WEBSOCKET_TLSHANDSHAKEFAILED),
