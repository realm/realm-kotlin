...
#ifndef REALM_JVM_NETWORK_TRANSPORT
#define REALM_JVM_NETWORK_TRANSPORT
...
struct JVMNetworkTransport : public app::GenericNetworkTransport {
    JVMNetworkTransport(jobject jvm_network_transport_impl) {
        JNIEnv* env = get_env(true);
//        m_jvm_network_transport_impl = env->NewGlobalRef(jvm_network_transport_impl);
//        jclass cls = env->GetObjectClass(m_jvm_network_transport_impl);
...
//        REALM_ASSERT_RELEASE_EX(m_send_request_method != nullptr, method_name, signature);
    ...
    void send_request_to_server(const app::Request request,
                                std::function<void(const app::Response)> completion_block) override final {
...
//    ~JVMNetworkTransport() {
//        JniUtils::get_env(true)->DeleteGlobalRef(m_jvm_network_transport_impl);
//    }

//private:
//    jobject m_jvm_network_transport_impl;     // Global ref of Java implementation of the network transport.
