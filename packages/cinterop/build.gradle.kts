    ...
    ios {
        compilations.getByName("main") {
            cinterops.create("realm_wrapper") {
                ...
                includeDirs(project.file("$corePath/src/"))
            }
...
fun Task.build_C_API_Macos_Universal(releaseBuild: Boolean = false) {
    ...
    doLast {
        ...
        exec {
            ...
            workingDir(project.file("$corePath/capi_macos_universal"))
        }
        exec {
            workingDir(project.file("$corePath/capi_macos_universal"))
    ...
    outputs.file(project.file("$corePath/capi_macos_universal/src/realm/object-store/c_api/librealm-ffi-static$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/capi_macos_universal/src/realm/librealm$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/capi_macos_universal/src/realm/object-store/c_api/librealm-ffi-static$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/capi_macos_universal/src/realm/object-store/librealm-object-store$buildTypeSuffix.a"))
}
...
fun Task.build_C_API_Simulator_Universal(releaseBuild: Boolean = false) {
    ...
    doLast {
        ...
        exec {
            workingDir(project.file("$corePath/build-simulator_universal"))
            commandLine(
    ...
    outputs.file(project.file("$corePath/build-simulator_universal/lib/librealm-ffi-static$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/build-simulator_universal/lib/librealm$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/build-simulator_universal/lib/librealm-parser$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/build-simulator_universal/lib/librealm-object-store$buildTypeSuffix.a"))
}
...
fun Task.build_C_API_iOS_Arm64(releaseBuild: Boolean = false) {
    ...
    doLast {
        ...
        exec {
            workingDir(project.file("$corePath/build-capi_ios_Arm64"))
            commandLine(
                "cmake", "-DCMAKE_TOOLCHAIN_FILE=../tools/cmake/ios.toolchain.cmake",
                "-DCMAKE_INSTALL_PREFIX=.",
                "-DCMAKE_BUILD_TYPE=$buildType",
    ...
    outputs.file(project.file("$corePath/build-capi_ios_Arm64/lib/librealm-ffi-static$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/build-capi_ios_Arm64/lib/librealm$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/build-capi_ios_Arm64/lib/librealm-parser$buildTypeSuffix.a"))
    outputs.file(project.file("$corePath/build-capi_ios_Arm64/lib/librealm-object-store$buildTypeSuffix.a"))
}
