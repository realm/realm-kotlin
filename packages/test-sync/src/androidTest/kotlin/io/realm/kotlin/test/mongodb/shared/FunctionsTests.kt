...
class FunctionsTests {
    ...
    fun smokeTest() = runBlocking {
        val result = user.functions.callFunction("foo")
        assertEquals("bar", result["foo"]!!.asString().value)
    }
}
...
//        when (type) {
//            BsonType.DOUBLE -> {
//                assertEquals(1.4f, functions.callFunction(FIRST_ARG_FUNCTION, listOf(1.4f), Float::class.java).toFloat())
//                assertEquals(1.4, functions.callFunction(FIRST_ARG_FUNCTION, listOf(1.4), Double::class.java).toDouble())
...
//                assertEquals(values1[0], functions.callFunction(FIRST_ARG_FUNCTION, values1, Boolean::class.java))
//
...
//            }
//            BsonType.INT64 -> {
//                assertEquals(32L, functions.callFunction(FIRST_ARG_FUNCTION, listOf(32L), Long::class.java).toLong())
//                assertEquals(32L, functions.callFunction(FIRST_ARG_FUNCTION, listOf(32), Long::class.java).toLong())
...
//
// @org.junit.Test
// @org.junit.Ignore("C++ parser does not support binary subtypes yet")
