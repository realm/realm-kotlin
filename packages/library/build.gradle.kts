...
publishing {
    ...
    common.artifact(tasks.named("dokkaJar"))
    // Common sources are not being generated by default, so add them explicitly.
    // https://kotlinlang.slack.com/archives/C3PQML5NU/p1608092682308100
    common.artifact(tasks.named("metadataSourcesJar"))
}
