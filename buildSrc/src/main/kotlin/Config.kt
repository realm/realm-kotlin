...
object Realm {
    ...
    const val version = "1.15.1-K2-SNAPSHOT"
...
object Versions {
    ...
    const val kotlin = "2.0.0-RC1" // https://github.com/JetBrains/kotlin and https://kotlinlang.org/docs/releases.html#release-details
    const val kotlinJvmTarget = "1.8" // Which JVM bytecode version is kotlin compiled to.
    const val latestKotlin = "2.0.0-RC1" // https://kotlinlang.org/docs/eap.html#build-details
