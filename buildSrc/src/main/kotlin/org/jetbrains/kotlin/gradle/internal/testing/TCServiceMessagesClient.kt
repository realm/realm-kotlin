// Forked from https://github.com/JetBrains/kotlin/blob/v1.7.21/libraries/tools/kotlin-gradle-plugin/src/common/kotlin/org/jetbrains/kotlin/gradle/internal/testing/TCServiceMessagesClient.kt
// which needs to be modified to comply with a newer Gradle API to address https://youtrack.jetbrains.com/issue/KT-54634
...
internal open class TCServiceMessagesClient(
    ...
    private fun TestNode.failure(
        ...
        results.failure(
            descriptor.id,
            TestFailure.fromTestAssertionFailure(
                KotlinTestFailure(
