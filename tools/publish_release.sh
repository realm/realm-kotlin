...
SIGN_KEY="$1"
SIGN_KEY_PASSWORD="$2"
MAVEN_CENTRAL_USER="$3"
MAVEN_CENTRAL_KEY="$4"
REALM_S3_ACCESS_KEY="$5"
REALM_S3_SECRET_KEY="$6"
DOCS_S3_ACCESS_KEY="$7"
DOCS_S3_SECRET_KEY="$8"
SLACK_WEBHOOK_RELEASES_URL="$9"
SLACK_WEBHOOK_JAVA_CI_URL="$10"
GRADLE_PORTAL_KEY="$11"
GRADLE_PORTAL_KEY="$12"
GRADLE_BUILD_PARAMS="-PsignBuild=true -PsignSecretRingFileKotlin=\"$SIGN_KEY\" -PsignPasswordKotlin=$SIGN_KEY_PASSWORD"
echo "$GRADLE_PORTAL_KEY"
...
publish_artifacts() {
  ...
  cd $REALM_KOTLIN_PATH/packages
  cmd="./gradlew signAndroidDebugPublication $GRADLE_BUILD_PARAMS -PossrhUsername=$MAVEN_CENTRAL_USER -PossrhPassword=$MAVEN_CENTRAL_KEY"
  echo $cmd
  eval $cmd
