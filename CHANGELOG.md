...
### Enhancements
* Support for storing geographical locations and perform geo spatial queries using the new classes: `GeoPoint`, `GeoCircle`, `GeoBox` and `GeoPolygon`. (Issue [#1403](https://github.com/realm/realm-kotlin/pull/1403))
