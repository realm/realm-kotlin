...
* Support for Kotlin 1.9's experimental K2 compilation. (Issue [#1483](https://github.com/realm/realm-kotlin/issues/1483))
...
* This release is compatible with the following Kotlin releases:
  * Kotlin 1.8.20 and above. Support for experimental K2 compilation from Kotlin 1.9.0 with `kotlin.experimental.tryK2=true`.
