...
* [Sync] Added `SyncClientResetStrategy` which enables support for client reset via `DiscardUnsyncedChangesStrategy` for partition-based realms and `ManuallyRecoverUnsyncedChangesStrategy` for Flexible Sync realms.
...
### Internal
* Updated to Realm Core 12.0.0, commit f93fb39310b4d6acc88cd58db3ac509498b6d449.
