...
* Updated Kotlin to 1.6.10 in this version. The entry under `Compatibility` for 0.8.0 stating that the project had been updated to Kotlin 1.6.10 was bogus [#640](https://github.com/realm/realm-kotlin/issues/640).
