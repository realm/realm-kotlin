...
### Breaking Changes
* [Sync] Improved exception hiearchy for App and Sync exceptions. All sync/app exceptions now has `io.realm.mongodb.exceptions.AppException` as their top-level exception type and many methods have more specialized exceptions for common errors than can be caught and reacted to. See `AppException` documentation for more details. 
