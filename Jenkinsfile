    ...
    node('android') {
        ...
        try {
            ...
            sh '''
                ...
                mkdir /tmp/ktlint
                mkdir /tmp/detekt
                rsync -a --delete --ignore-errors examle/build/reports/ktlint/ /tmp/ktlint/example/ || true 
                ...
                rsync -a --delete --ignore-errors examle/build/reports/detekt/ /tmp/detekt/example/ || true 
                ...
                rsync -a --delete --ignore-errors packages/plugin-compiler-shaded/build/reports/detekt/ /tmp/detekt/plugin-compiler-shaded/  || true
