...
def testWithServer(tasks) {
    ...
    withCredentials([
        ...
        try {
            ...
            sh "tools/sync_test_server/app_config_generator.sh ${tempDir} tools/sync_test_server/app_template partition function testapp2"
            sh "tools/sync_test_server/app_config_generator.sh ${tempDir} tools/sync_test_server/app_template flex auto testapp3"
